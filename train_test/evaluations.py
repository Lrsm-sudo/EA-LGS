...
def roc_pr_curve(y_true, y_scores, path_experiment):
    ...
    # np.save('/root/code/Vessel_Net/only_for_vessel_seg/log/visual_results/DRIVE_(UU_C_1)_17_(3_GT)/fpr.npy', fpr)
    # np.save('/root/code/Vessel_Net/only_for_vessel_seg/log/visual_results/DRIVE_(UU_C_1)_17_(3_GT)/tpr.npy', tpr)
    np.save('/home/computer/lzz/code/CS_Net_master/only_for_vessel_seg/log/weights_save/BSPC_DRIVE_2_Unetpp/fpr.npy', fpr)
    np.save('/home/computer/lzz/code/CS_Net_master/only_for_vessel_seg/log/weights_save/BSPC_DRIVE_2_Unetpp/tpr.npy', tpr)
    ...
    np.save('/home/computer/lzz/code/CS_Net_master/only_for_vessel_seg/log/weights_save/BSPC_DRIVE_2_Unetpp/precision.npy', precision)
    np.save('/home/computer/lzz/code/CS_Net_master/only_for_vessel_seg/log/weights_save/BSPC_DRIVE_2_Unetpp/recall.npy', recall)
